...
;top left collision data
  ...
  JSR CHECK_COLLISION
  beq increase
  ;inc player_x ; ejecting player from wehre they collided

;bottom left collision  data
  lda player_x
  clc
  adc #01
  TAX
  ...
  check_right:
    ...
    bne keepergoinr
    decrease:
    dec player_x ; ejecting player from wehre they collided
    keepergoinr:   ; no collision
  ...
  check_up:
   ...
   ; STA COLISIONY
    JSR CHECK_COLLISION
    beq incr
    ; inc player_y ; ejecting player from wehre they collided
  ...
  check_down:
   ...
   ; STA COLISIONY
    ...
    bne keepergoind
    decr:
    dec player_y ; ejecting player from wehre they collided

    keepergoind:   ; no collision
    LDA #$03
    STA player_look
  ...
  check_finish:
    ;if position is 20DE if y 16 and x 3
      lda doner
      cmp #$00
      beq done_checking
      lda #$08
      ...
      vblankwaitstage2:       ; wait for another vblank before continuing
      BIT PPUSTATUS
      BPL vblankwaitstage2
      LDA #%00  ; turn on NMIs, sprites use first pattern table
      STA PPUCTRL
      sta PPUMASK
      jsr main
...
.proc CHECK_COLLISION
    ...
    ;TAY ;byte index  = myb  + 4mxb   BYTE INDEX = Y
    LDA COLISIONX ; X /16 MOD4(AND3)
    ror A
    clc
    ror A
    clc
